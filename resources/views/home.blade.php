    ...
    <main>
        ...
        <div class="mx-auto w-full max-w-xl px-4">
            <p class="mb-12 mt-2 text-center text-xs">
                When you buy through links on CouponOnTop <a class="underline" href="" target="_blank">we may earn
                    a commission.</a>
            </p>
            ...
            <section class="mb-16 md:mb-20">
                ...
                <div class="mb-6 flex flex-wrap justify-between lg:mb-0">
                    ...
                    <a class="block text-xs font-semibold uppercase tracking-widest underline underline-offset-4"
                        href="">All Cash Back</a>
                </div>
            ...
            <section class="mb-12 flex flex-col md:mb-20 md:flex-row md:border md:border-gray-200 md:shadow-md"
                data-component-class="video_spotlight_module" data-discoverable=""
                data-content-uuid="01jwyfmx938dn582e2kf0rt8tx" data-content-datastore="video_spotlight"
                ...
                <div class="aspect-video w-full bg-gray-200 drop-shadow md:w-2/3 md:drop-shadow-none">
                    <iframe class="h-full w-full" src="https://embed.mindstamp.com/e/OOyWdjYgpVcL"
                        title="Video Spotlight" allowfullscreen="" allow="encrypted-media; geolocation" scrolling="no"
                        referrerpolicy="no-referrer-when-downgrade">
                    </iframe>
                </div>
                <div
                    class="order-first w-full md:order-none md:mx-6 md:flex md:w-1/3 md:flex-col md:place-content-center md:py-1">
                    <h2 class="mb-4 text-xl font-bold capitalize leading-tight md:mb-0 md:text-2xl md:leading-normal">Top
                        Summer Travel Deals for the Trip of a Lifetime</h2>
                    <p class="mt-2.5 hidden md:block">Get away for a while in style — without breaking the bank. Watch our
                        interactive video for our exclusive, limited-time savings.</p>
                </div>
            </section>

            <div class="mb-16 md:mb-20">
                <a class="brand-theme-yellow-light flex items-center justify-between gap-8 overflow-x-scroll rounded px-8 shadow-md scrollbar-hide"
                    href="">
                    <img src="https://www.CouponOnTop.com/imagery/dream-bars/01jwrxz2stqwt5b46kmnt9t17d-desktop-image.fit_limit.quality_80.size_2400x160.v1748888423.png.webp"
                        srcset="https://www.CouponOnTop.com/imagery/dream-bars/01jwrxz2stqwt5b46kmnt9t17d-desktop-image.fit_limit.quality_80.size_2400x160.v1748888423.png.webp 1x, https://www.CouponOnTop.com/imagery/dream-bars/01jwrxz2stqwt5b46kmnt9t17d-desktop-image.fit_limit.quality_80.size_4800x320.v1748888423.png.webp 2x"
                        type="image/webp" alt="dream bar" class="hidden sm:block" width="2400" height="160">
                    <img src="https://www.CouponOnTop.com/imagery/dream-bars/01jwrxz2stqwt5b46kmnt9t17d-mobile-image.fit_limit.quality_80.size_840x560.v1748888423.png.webp"
                        srcset="https://www.CouponOnTop.com/imagery/dream-bars/01jwrxz2stqwt5b46kmnt9t17d-mobile-image.fit_limit.quality_80.size_840x560.v1748888423.png.webp 1x, https://www.CouponOnTop.com/imagery/dream-bars/01jwrxz2stqwt5b46kmnt9t17d-mobile-image.fit_limit.quality_80.size_1680x1120.v1748888423.png.webp 2x"
                        type="image/webp" alt="dream bar" class="block sm:hidden" width="840" height="560">
                </a>
            </div>
            ...
            <section class="mb-8 max-w-xl pt-4 md:mb-10" id="summer-checklist">
                <div class="mb-6 flex flex-wrap items-center justify-between lg:mb-0">
                    ...
                    <a class="block text-sm text-xs font-semibold uppercase tracking-widest underline underline-offset-4"
                        href="">Summer Checklist Deals</a>
                </div>
            ...
            <div class="lg:space-x-2 flex flex-col bg-dynamic lg:flex-row lg:flex-wrap" style="--dynamic:#36C1D214">
                <div class="w-full text-center">
                    <a class="mx-auto inline-block" href=""><img class="mx-auto my-4 w-full"
                            src="/svg/images/realdeal-logo.svg" alt="The real deal by CouponOnTop" width="280"
                            height="80"></a>
                </div>
                ...
                <div class="relative p-4 lg:w-2/3">
                    <a href="" x-data=""
                        @click="window.Alpine.store('googleEvents').sendClickEvent({'template':'home','module':'spotlight','element':'card','position':'1','object_type':'spotlight','object_uuid':'01jftwajdz6vvxvmjj3x3ne24d','destination_url':'https:\/\/www.CouponOnTop.com\/blog\/summer-checklist'})">
                        <div class="mb-4 relative">
                            <img src="https://www.CouponOnTop.com/imagery/spotlights/01jftwajdz6vvxvmjj3x3ne24d.fit_limit.quality_80.size_1363x700.v1749130530.jpg.webp"
                                srcset="https://www.CouponOnTop.com/imagery/spotlights/01jftwajdz6vvxvmjj3x3ne24d.fit_limit.quality_80.size_1363x700.v1749130530.jpg.webp 1x, https://www.CouponOnTop.com/imagery/spotlights/01jftwajdz6vvxvmjj3x3ne24d.fit_limit.quality_80.size_2726x1400.v1749130530.jpg.webp 2x"
                                type="image/webp" alt="Summer Checklist"
                                class="block h-auto w-full rounded-2xl md:rounded-4xl" width="1363" height="700">
                ...
                <div class="p-4 lg:w-1/3">
                    <a href="" x-data=""
                        @click="window.Alpine.store('googleEvents').sendClickEvent({'template':'home','module':'spotlight','element':'card','position':'2','object_type':'spotlight','object_uuid':'01jvz6djq8k39vkbw13ew9srs3','destination_url':'https:\/\/www.CouponOnTop.com\/blog\/25-best-fathers-day-gifts'})">
                        <div class="mb-4 flex items-center">
                            <img src="https://www.CouponOnTop.com/imagery/spotlights/01jvz6djq8k39vkbw13ew9srs3.fit_limit.quality_80.size_250x128.v1748921080.jpg.webp"
                                srcset="https://www.CouponOnTop.com/imagery/spotlights/01jvz6djq8k39vkbw13ew9srs3.fit_limit.quality_80.size_250x128.v1748921080.jpg.webp 1x, https://www.CouponOnTop.com/imagery/spotlights/01jvz6djq8k39vkbw13ew9srs3.fit_limit.quality_80.size_500x256.v1748921080.jpg.webp 2x"
                                type="image/webp" alt="25 Best Picks" class="h-32 w-36 rounded-2xl object-cover"
                    ...
                    <a href="" x-data=""
                        @click="window.Alpine.store('googleEvents').sendClickEvent({'template':'home','module':'spotlight','element':'card','position':'3','object_type':'spotlight','object_uuid':'01jftvv4mkrae4z3ced1kz9344','destination_url':'https:\/\/www.CouponOnTop.com\/blog\/made-in-america-our-favorite-brands.html'})">
                        <div class="mb-4 flex items-center">
                            <img src="https://www.CouponOnTop.com/imagery/spotlights/01jftvv4mkrae4z3ced1kz9344.fit_limit.quality_80.size_250x128.v1749130868.jpg.webp"
                                srcset="https://www.CouponOnTop.com/imagery/spotlights/01jftvv4mkrae4z3ced1kz9344.fit_limit.quality_80.size_250x128.v1749130868.jpg.webp 1x, https://www.CouponOnTop.com/imagery/spotlights/01jftvv4mkrae4z3ced1kz9344.fit_limit.quality_80.size_500x256.v1749130868.jpg.webp 2x"
                                type="image/webp" alt="Shop Now" class="h-32 w-36 rounded-2xl object-cover"
                                width="250" height="128">
                            <div class="p-4">
                    ...
                    <a href="" x-data=""
                        @click="window.Alpine.store('googleEvents').sendClickEvent({'template':'home','module':'spotlight','element':'card','position':'4','object_type':'spotlight','object_uuid':'01jtv0t588x0baygbvr70665sc','destination_url':'https:\/\/www.CouponOnTop.com\/blog\/tag\/local-gem'})">
                        <div class="mb-4 flex items-center">
                            <img src="https://www.CouponOnTop.com/imagery/spotlights/01jtv0t588x0baygbvr70665sc.fit_limit.quality_80.size_250x128.v1748024662.jpg.webp"
                                srcset="https://www.CouponOnTop.com/imagery/spotlights/01jtv0t588x0baygbvr70665sc.fit_limit.quality_80.size_250x128.v1748024662.jpg.webp 1x, https://www.CouponOnTop.com/imagery/spotlights/01jtv0t588x0baygbvr70665sc.fit_limit.quality_80.size_500x256.v1748024662.jpg.webp 2x"
                                type="image/webp" alt="Local Gem" class="h-32 w-36 rounded-2xl object-cover"
                                width="250" height="128">
                            <div class="p-4">
                    ...
                    <div class="group relative glide--ltr glide--carousel cursor-auto">
                        <div class="relative mb-6 flex gap-x-4">
                            <a href="" target="_blank" title="(opens in new tab)">
                                <div class="border-dynamic h-24 w-24 border-gray-200 p-2 overflow-hidden rounded-full border bg-dynamic"
                                    style="--dynamic: #121821">
                                    <img src="https://www.CouponOnTop.com/imagery/merchants/05kie42h3YvHwjr4G1w80Qq-color.fit_limit.quality_80.size_86x86.v1749054405.png.webp"
                                        srcset="https://www.CouponOnTop.com/imagery/merchants/05kie42h3YvHwjr4G1w80Qq-color.fit_limit.quality_80.size_86x86.v1749054405.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/05kie42h3YvHwjr4G1w80Qq-color.fit_limit.quality_80.size_172x172.v1749054405.png.webp 2x"
                                        type="image/webp" alt="Amazon"
                                        class="aspect-square h-auto w-full object-contain" loading="auto" width="86"
                                        height="86">
                                </div>
                            </a>
                            <div>
                                ...
                                <a href="" target="_blank" title="(opens in new tab)"
                                    class="mt-3 flex items-center text-xs font-bold uppercase tracking-wider"
                                    data-component-name="product_deal.cbo_link" opensnewtab="true"
                                    x-data="outclickHandler({ 'siteLink': '?u=Y3HARKE6XZGVBDWGWGGJYL7MNY&amp;outclicked=true&amp;element=product_deals', 'offerType': 'REWARD', 'requestSlug': 'amazon.com', 'offerUuid': 'Y3HARKE6XZGVBDWGWGGJYL7MNY' })"
                                    @click="window.Alpine.store('googleEvents').sendClickEvent({ 'template': 'home', 'module': 'product_deals', 'element': 'product_deals', 'item': 'cbo_link' }); juggleTabs($event);"><img
                                        class="h-5 w-5" src="/svg/images/cashback-bolt.svg" alt=""
                                    ...
                                    <svg class="ml-1 h-5 w-5" fill="none" viewBox="0 0 20 12">
                                        <path fill="currentColor"
                                            d="M13.363.161c.172-.215.516-.215.73 0l4.985 4.985a.494.494 0 0 1 0 .73l-4.984 4.984c-.215.215-.559.215-.73 0l-.344-.3a.58.58 0 0 1 0-.73l3.609-3.61H.516A.496.496 0 0 1 0 5.704v-.43c0-.257.215-.515.516-.515h16.113l-3.61-3.567a.58.58 0 0 1 0-.73z">
                                        </path>
                                    </svg></a>
                            </div>
                            <a href="" target="_blank" title="(opens in new tab)"
                                class="absolute bottom-3 right-0.5 hidden h-11 items-center whitespace-nowrap rounded-full border border-black bg-white px-4 py-1.5 text-xs font-bold text-black lg:flex"
                                data-component-name="product_deal.view_more_deals" x-data=""
                                @click="window.blizzard?.trackClickEvent({type: 'click', event: $event, element: $el}); window.Alpine.store('googleEvents').sendClickEvent({ 'template': 'home', 'module': 'product_deals', 'element': 'product_deals', 'item': 'view_more_deals' });">View
                                more deals</a>
                        </div>
                        <div class="glide-amazon">
                            ...
                            <div class="glide h-52">
                                <div class="glide__track" data-glide-el="track" style="overflow: visible;">
                                    <div class="glide__slides"
                                        style="overflow: visible; transition: transform cubic-bezier(0.165, 0.84, 0.44, 1); width: 4230px; transform: translate3d(-1410px, 0px, 0px);"
                                        x-ref="slider">
                                        <a href="" target="_blank" title="(opens in new tab)"
                                            class="glide__slide overflow-hidden rounded-md border-l border-t border-[#F7F7F7] shadow-lg lg:hover:shadow-xl glide__slide--clone"
                                            data-component-class="product_deal.tile"
                                            data-content-datastore="blender.offer"
                                            data-content-uuid="06u5YV6VOC0Xcws1V0TPB6Z" data-position="1"
                                            x-data=""
                                            @click="window.blizzard.trackClickEvent({type: 'outclick', event: $event, element: $el})"
                                            tabindex="-1" style="width: 270px; margin-right: 6px;">
                                            <div class="grid h-36 grid-cols-9">
                                                <div class="col-span-4 flex h-full items-center justify-center p-1">
                                                    <img src="https://www.CouponOnTop.com/imagery/product_offers/01jx3f0475kcwy0g4y71v0pgpy.fit_limit.quality_80.size_125x125.v1749465028.jpg.webp"
                                                        srcset="https://www.CouponOnTop.com/imagery/product_offers/01jx3f0475kcwy0g4y71v0pgpy.fit_limit.quality_80.size_125x125.v1749465028.jpg.webp 1x, https://www.CouponOnTop.com/imagery/product_offers/01jx3f0475kcwy0g4y71v0pgpy.fit_limit.quality_80.size_250x250.v1749465028.jpg.webp 2x"
                                                        type="image/webp" alt="" class="primary-image"
                                                        width="125" height="125">
                                                </div>
                                                <div class="col-span-5 flex h-36 flex-col gap-y-2 bg-[#F7F7F7] p-3">
                                                    <div class="inline-flex">
                                                        <span
                                                            class="inline-flex h-6 items-center rounded-md border border-[#E0E0E0] bg-white py-1 pr-1 text-xs font-semibold uppercase leading-none tracking-widest">
                                                            <img class="h-6 w-6" src="/svg/images/flame.svg"
                                                                alt="" role="presentation" width="24"
                                                                height="24">
                                                            <span class="pt-px">43% Off</span>
                                                        </span>
                                                    </div>
                                                    <div class="flex grow flex-col justify-between">
                                                        <p class="line-clamp-3 text-xs font-medium">Amazon Fire TV Stick HD
                                                            1080p</p>
                                                        <div
                                                            class="flex items-center justify-center gap-x-1 sm:justify-normal">
                                                            <button
                                                                class="whitespace-nowrap rounded-full bg-gray-200 px-2.5 py-2 text-xs font-bold text-black sm:px-4"
                                                                tabindex="-1">Check price</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </a><a href="" target="_blank" title="(opens in new tab)"
                                            class="glide__slide overflow-hidden rounded-md border-l border-t border-[#F7F7F7] shadow-lg lg:hover:shadow-xl glide__slide--clone"
                                            data-component-class="product_deal.tile"
                                            data-content-datastore="blender.offer"
                                            data-content-uuid="0714KZFAn38Ue0zNbEdJNkf" data-position="2"
                                            x-data=""
                                            @click="window.blizzard.trackClickEvent({type: 'outclick', event: $event, element: $el})"
                                            tabindex="-1" style="width: 270px; margin-left: 6px; margin-right: 6px;">
                                            <div class="grid h-36 grid-cols-9">
                                                <div class="col-span-4 flex h-full items-center justify-center p-1">
                                                    <img src="https://www.CouponOnTop.com/imagery/product_offers/01jx3m6k8ydhg7d0jxbk97fza7.fit_limit.quality_80.size_125x125.v1749465030.jpg.webp"
                                                        srcset="https://www.CouponOnTop.com/imagery/product_offers/01jx3m6k8ydhg7d0jxbk97fza7.fit_limit.quality_80.size_125x125.v1749465030.jpg.webp 1x, https://www.CouponOnTop.com/imagery/product_offers/01jx3m6k8ydhg7d0jxbk97fza7.fit_limit.quality_80.size_250x250.v1749465030.jpg.webp 2x"
                                                        type="image/webp" alt="" class="primary-image"
                                                        width="125" height="125">
                                                </div>
                                                <div class="col-span-5 flex h-36 flex-col gap-y-2 bg-[#F7F7F7] p-3">
                                                    ...
                                                    <div class="flex grow flex-col justify-between">
                                                        <p class="line-clamp-3 text-xs font-medium">Stanley All Day Slim
                                                            Bottle 20oz with Leakproof Twist on Lid (Lilac)</p>
                                                        <div
                                                            class="flex items-center justify-center gap-x-1 sm:justify-normal">
                                                            <button
                                                                class="whitespace-nowrap rounded-full bg-gray-200 px-2.5 py-2 text-xs font-bold text-black sm:px-4"
                                            ...
                                            data-component-class="product_deal.tile"
                                            data-content-datastore="blender.offer"
                                            data-content-uuid="04pnzu5LQZlmVuuomfRbpHO" data-position="3"
                                            x-data=""
                                            @click="window.blizzard.trackClickEvent({type: 'outclick', event: $event, element: $el})"
                                            tabindex="-1" style="width: 270px; margin-left: 6px; margin-right: 6px;">
                                            <div class="grid h-36 grid-cols-9">
                                                <div class="col-span-4 flex h-full items-center justify-center p-1">
                                                    <img src="https://www.CouponOnTop.com/imagery/product_offers/01jx3jdzx1k5yksdjt9bxw3h00.fit_limit.quality_80.size_125x125.v1749465029.jpg.webp"
                                                        srcset="https://www.CouponOnTop.com/imagery/product_offers/01jx3jdzx1k5yksdjt9bxw3h00.fit_limit.quality_80.size_125x125.v1749465029.jpg.webp 1x, https://www.CouponOnTop.com/imagery/product_offers/01jx3jdzx1k5yksdjt9bxw3h00.fit_limit.quality_80.size_250x250.v1749465029.jpg.webp 2x"
                                                        type="image/webp" alt="" class="primary-image"
                                                        width="125" height="125">
                                                </div>
                                                <div class="col-span-5 flex h-36 flex-col gap-y-2 bg-[#F7F7F7] p-3">
                                                    ...
                                                    <div class="flex grow flex-col justify-between">
                                                        <p class="line-clamp-3 text-xs font-medium">Apple AirPods Pro (2nd
                                                            Gen) with MagSafe Charging Case (USB-C)</p>
                                                        <div
                                                            class="flex items-center justify-center gap-x-1 sm:justify-normal">
                                                            <button
                                                                class="whitespace-nowrap rounded-full bg-gray-200 px-2.5 py-2 text-xs font-bold text-black sm:px-4"
                                            ...
                                            data-component-class="product_deal.tile"
                                            data-content-datastore="blender.offer"
                                            data-content-uuid="041Lk0Ca2olnivls1LsSaE3" data-position="4"
                                            x-data=""
                                            @click="window.blizzard.trackClickEvent({type: 'outclick', event: $event, element: $el})"
                                            tabindex="-1" style="width: 270px; margin-left: 6px; margin-right: 6px;">
                                            <div class="grid h-36 grid-cols-9">
                                                <div class="col-span-4 flex h-full items-center justify-center p-1">
                                                    <img src="https://www.CouponOnTop.com/imagery/product_offers/01jwxy7tggrwg6bxbth3spd9j8.fit_limit.quality_80.size_125x125.v1749465029.jpg.webp"
                                                        srcset="https://www.CouponOnTop.com/imagery/product_offers/01jwxy7tggrwg6bxbth3spd9j8.fit_limit.quality_80.size_125x125.v1749465029.jpg.webp 1x, https://www.CouponOnTop.com/imagery/product_offers/01jwxy7tggrwg6bxbth3spd9j8.fit_limit.quality_80.size_250x250.v1749465029.jpg.webp 2x"
                                                        type="image/webp" alt="" class="primary-image"
                                                        width="125" height="125">
                                                </div>
                                                <div class="col-span-5 flex h-36 flex-col gap-y-2 bg-[#F7F7F7] p-3">
                                                    ...
                                                    <div class="flex grow flex-col justify-between">
                                                        <p class="line-clamp-3 text-xs font-medium">Bkppm 70oz 6-Preset
                                                            Self-Clean Slushie Machine</p>
                                                        <div
                                                            class="flex items-center justify-center gap-x-1 sm:justify-normal">
                                                            <button
                                                                class="whitespace-nowrap rounded-full bg-gray-200 px-2.5 py-2 text-xs font-bold text-black sm:px-4"
                                            ...
                                            data-component-class="product_deal.tile"
                                            data-content-datastore="blender.offer"
                                            data-content-uuid="04a7LYaROQJPMJ7Uv51eQUe" data-position="5"
                                            x-data=""
                                            @click="window.blizzard.trackClickEvent({type: 'outclick', event: $event, element: $el})"
                                            tabindex="-1" style="width: 270px; margin-left: 6px; margin-right: 6px;">
                                            <div class="grid h-36 grid-cols-9">
                                                <div class="col-span-4 flex h-full items-center justify-center p-1">
                                                    <img src="https://www.CouponOnTop.com/imagery/product_offers/01jvswnz6kd7mq2q0f6qfr3xpe.fit_limit.quality_80.size_125x125.v1749465029.jpg.webp"
                                                        srcset="https://www.CouponOnTop.com/imagery/product_offers/01jvswnz6kd7mq2q0f6qfr3xpe.fit_limit.quality_80.size_125x125.v1749465029.jpg.webp 1x, https://www.CouponOnTop.com/imagery/product_offers/01jvswnz6kd7mq2q0f6qfr3xpe.fit_limit.quality_80.size_250x250.v1749465029.jpg.webp 2x"
                                                        type="image/webp" alt="" class="primary-image"
                                                        width="125" height="125">
                                                </div>
                                                <div class="col-span-5 flex h-36 flex-col gap-y-2 bg-[#F7F7F7] p-3">
                                                    ...
                                                    <div class="flex grow flex-col justify-between">
                                                        <p class="line-clamp-3 text-xs font-medium">Dyson Supersonic Nural
                                                            Limited Edition Hair Dryer (Jasper Plum)</p>
                                                        <div
                                                            class="flex items-center justify-center gap-x-1 sm:justify-normal">
                                                            <button
                                                                class="whitespace-nowrap rounded-full bg-gray-200 px-2.5 py-2 text-xs font-bold text-black sm:px-4"
                                            ...
                                            class="glide__slide overflow-hidden rounded-md border-l border-t border-[#F7F7F7] shadow-lg lg:hover:shadow-xl glide__slide--active"
                                            data-component-class="product_deal.tile"
                                            data-content-datastore="blender.offer"
                                            data-content-uuid="06u5YV6VOC0Xcws1V0TPB6Z" data-position="1"
                                            x-data=""
                                            @click="window.blizzard.trackClickEvent({type: 'outclick', event: $event, element: $el})"
                                            tabindex="0" style="width: 270px; margin-left: 6px; margin-right: 6px;">
                                            <div class="grid h-36 grid-cols-9">
                                                <div class="col-span-4 flex h-full items-center justify-center p-1">
                                                    <img src="https://www.CouponOnTop.com/imagery/product_offers/01jx3f0475kcwy0g4y71v0pgpy.fit_limit.quality_80.size_125x125.v1749465028.jpg.webp"
                                                        srcset="https://www.CouponOnTop.com/imagery/product_offers/01jx3f0475kcwy0g4y71v0pgpy.fit_limit.quality_80.size_125x125.v1749465028.jpg.webp 1x, https://www.CouponOnTop.com/imagery/product_offers/01jx3f0475kcwy0g4y71v0pgpy.fit_limit.quality_80.size_250x250.v1749465028.jpg.webp 2x"
                                                ...
                                                <div class="col-span-5 flex h-36 flex-col gap-y-2 bg-[#F7F7F7] p-3">
                                                    ...
                                                    <div class="flex grow flex-col justify-between">
                                                        <p class="line-clamp-3 text-xs font-medium">Amazon Fire TV Stick
                                                            HD 1080p</p>
                                                        <div
                                                            class="flex items-center justify-center gap-x-1 sm:justify-normal">
                                                            <button
                                        ...
                                        <a href="" target="_blank" title="(opens in new tab)"
                                            class="glide__slide overflow-hidden rounded-md border-l border-t border-[#F7F7F7] shadow-lg lg:hover:shadow-xl"
                                            data-component-class="product_deal.tile"
                                            data-content-datastore="blender.offer"
                                            data-content-uuid="0714KZFAn38Ue0zNbEdJNkf" data-position="2"
                                            x-data=""
                                        ...
                                        <a href="" data-component-class="product_deal.tile"
                                            data-content-datastore="blender.offer"
                                            data-content-uuid="04a7LYaROQJPMJ7Uv51eQUe" data-position="5"
                                            x-data=""
                                            @click="window.blizzard.trackClickEvent({type: 'outclick', event: $event, element: $el})"
                                        ...
                                        <a href="" target="_blank" title="(opens in new tab)"
                                            ...
                                            x-data=""
                                            @click="window.blizzard.trackClickEvent({type: 'outclick', event: $event, element: $el})"
                                            tabindex="-1" style="width: 270px; margin-left: 6px;">
                                            <div class="grid h-36 grid-cols-9">
                                                <div class="col-span-4 flex h-full items-center justify-center p-1">
                                                    <img src="https://www.CouponOnTop.com/imagery/product_offers/01jvswnz6kd7mq2q0f6qfr3xpe.fit_limit.quality_80.size_125x125.v1749465029.jpg.webp"
                                                        srcset="https://www.CouponOnTop.com/imagery/product_offers/01jvswnz6kd7mq2q0f6qfr3xpe.fit_limit.quality_80.size_125x125.v1749465029.jpg.webp 1x, https://www.CouponOnTop.com/imagery/product_offers/01jvswnz6kd7mq2q0f6qfr3xpe.fit_limit.quality_80.size_250x250.v1749465029.jpg.webp 2x"
                            ...
                            <div data-glide-el="controls">
                                <button
                                    class="absolute left-4 top-1/2 z-[2] mt-4 grid hidden h-8 w-8 -translate-y-1/2 cursor-pointer place-items-center rounded-full bg-white group-focus-within:block group-hover:md:block"
                                    data-glide-dir="&lt;" aria-label="previous">
                                    <svg class="absolute left-1/2 top-1/2 -ml-px inline-block h-4 w-4 -translate-x-1/2 -translate-y-1/2 text-black ease-out"
                                        fill="none" viewBox="0 0 11 17">
                                        <path fill="currentColor"
                                            d="m.548 7.67 6.64-6.64a1.167 1.167 0 0 1 1.656 0l1.103 1.103a1.167 1.167 0 0 1 0 1.655L5.245 8.5l4.707 4.707a1.167 1.167 0 0 1 0 1.655L8.85 15.971a1.167 1.167 0 0 1-1.656 0L.553 9.33a1.17 1.17 0 0 1-.005-1.66">
                                        </path>
                                    </svg> </button>
                                <button
                                    class="absolute right-4 top-1/2 z-[2] mt-4 grid hidden h-8 w-8 -translate-y-1/2 cursor-pointer place-items-center rounded-full bg-white group-focus-within:block group-hover:md:block"
                                    data-glide-dir="&gt;" aria-label="next">
                                    <svg class="absolute left-1/2 top-1/2 ml-px inline-block h-4 w-4 -translate-x-1/2 -translate-y-1/2 rotate-180 text-black ease-out"
                                        fill="none" viewBox="0 0 11 17">
                                        <path fill="currentColor"
                                            d="m.548 7.67 6.64-6.64a1.167 1.167 0 0 1 1.656 0l1.103 1.103a1.167 1.167 0 0 1 0 1.655L5.245 8.5l4.707 4.707a1.167 1.167 0 0 1 0 1.655L8.85 15.971a1.167 1.167 0 0 1-1.656 0L.553 9.33a1.17 1.17 0 0 1-.005-1.66">
                                        </path>
                            ...
                            <div class="relative bottom-11 left-1/2 z-[2] inline-flex -translate-x-1/2 gap-x-2"
                                data-glide-el="controls[nav]">
                                <button class="h-[3px] w-11 cursor-pointer rounded bg-gray-200" data-glide-dir="=0"
                                    aria-label="Go to slide 1"></button>
                                <button class="h-[3px] w-11 cursor-pointer rounded bg-gray-200" data-glide-dir="=1"
                                    aria-label="Go to slide 2"></button>
                                <button class="h-[3px] w-11 cursor-pointer rounded bg-gray-200" data-glide-dir="=2"
                                    aria-label="Go to slide 3"></button>
                                <button class="h-[3px] w-11 cursor-pointer rounded bg-gray-200" data-glide-dir="=3"
                                    aria-label="Go to slide 4"></button>
                                <button class="h-[3px] w-11 cursor-pointer rounded bg-gray-200" data-glide-dir="=4"
                                    aria-label="Go to slide 5"></button>
                            </div>
                        </div>
                        <div class="relative bottom-11 mt-8 flex items-center justify-center lg:hidden">
                            <a href="" target="_blank" title="(opens in new tab)"
                                class="h-11 whitespace-nowrap rounded-full border border-black bg-white px-4 py-1.5 text-xs font-bold leading-8 text-black"
                                data-component-name="product_deal.view_more_deals" x-data=""
                                @click="window.blizzard?.trackClickEvent({type: 'click', event: $event, element: $el}); window.Alpine.store('googleEvents').sendClickEvent({ 'template': 'home', 'module': 'product_deals', 'element': 'product_deals', 'item': 'view_more_deals' });">View
                                more deals</a>
                        </div>
            ...
            <section class="mb-8 max-w-xl pt-4 md:mb-10" id="top-deals">
                ...
                <ul class="grid grid-cols-1 gap-4 md:grid-cols-4 lg:grid-cols-5">
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="5XQGGYQ7XRG4LJJLSEJOKES2FE" data-position="1" x-data="outclickHandler({ 'siteLink': '?u=5XQGGYQ7XRG4LJJLSEJOKES2FE&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'vitaminshoppe.com', 'offerUuid': '5XQGGYQ7XRG4LJJLSEJOKES2FE' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/06Sy6cqjpu7oDIYTZEU6Nsv.fit_limit.quality_80.size_300x130.v1749061747.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/06Sy6cqjpu7oDIYTZEU6Nsv.fit_limit.quality_80.size_300x130.v1749061747.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/06Sy6cqjpu7oDIYTZEU6Nsv.fit_limit.quality_80.size_600x260.v1749061747.png.webp 2x"
                                type="image/webp"
                                alt="The Vitamin Shoppe Up to $20 Off with Minimum Spend + Free Shipping"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#f7f7f7" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div>
                                    <h3 class="text-xs font-bold uppercase tracking-wide md:mt-2">The Vitamin Shoppe</h3>
                                    <p
                                        class="my-2 line-clamp-2 font-proxima text-base capitalize leading-5 md:mb-auto md:line-clamp-3">
                                        Up to $20 Off with Minimum Spend + Free Shipping</p>
                                </div>
                                <p class="mt-2 self-start rounded-full bg-gray-100 px-4 py-1.5 text-xs font-bold lg:mb-1">
                                    Coupon code</p>
                            </div>
                    ...
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="UBLNECL3DVEWDH3K37PWKGP3X4" data-position="2" x-data="outclickHandler({ 'siteLink': '?u=UBLNECL3DVEWDH3K37PWKGP3X4&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'walgreens.com', 'offerUuid': 'UBLNECL3DVEWDH3K37PWKGP3X4' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/036AtPTSfEi6mICq0oPedW7-color.fit_limit.quality_80.size_300x130.v1749059013.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/036AtPTSfEi6mICq0oPedW7-color.fit_limit.quality_80.size_300x130.v1749059013.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/036AtPTSfEi6mICq0oPedW7-color.fit_limit.quality_80.size_600x260.v1749059013.png.webp 2x"
                                type="image/webp" alt="Walgreens Extra 15% Off $35+ Sitewide"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#e51837" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div>
                                    <h3 class="text-xs font-bold uppercase tracking-wide md:mt-2">Walgreens</h3>
                                    <p
                                        class="my-2 line-clamp-2 font-proxima text-base capitalize leading-5 md:mb-auto md:line-clamp-3">
                                        Extra 15% Off $35+ Sitewide</p>
                                </div>
                                <p class="mt-2 self-start rounded-full bg-gray-100 px-4 py-1.5 text-xs font-bold lg:mb-1">
                                    Coupon code</p>
                            </div>
                    ...
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="MR74YMEOTZEPND6G4FVB7QTXC4" data-position="3" x-data="outclickHandler({ 'siteLink': '?u=MR74YMEOTZEPND6G4FVB7QTXC4&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'vitacost.com', 'offerUuid': 'MR74YMEOTZEPND6G4FVB7QTXC4' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/02VzMxiMUYD7g9kkr7whoAD.fit_limit.quality_80.size_300x130.v1749056097.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/02VzMxiMUYD7g9kkr7whoAD.fit_limit.quality_80.size_300x130.v1749056097.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/02VzMxiMUYD7g9kkr7whoAD.fit_limit.quality_80.size_600x260.v1749056097.png.webp 2x"
                                type="image/webp" alt="Vitacost 15% Off Your Eligible Order"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#f7f7f7" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div>
                    ...
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="JJ2ORQ4JPBCA3B2WWD72ZUFPLE" data-position="4" x-data="outclickHandler({ 'siteLink': '?u=JJ2ORQ4JPBCA3B2WWD72ZUFPLE&amp;outclicked=true', 'offerType': 'SALE', 'requestSlug': '1800contacts.com', 'offerUuid': 'JJ2ORQ4JPBCA3B2WWD72ZUFPLE' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/06awWdi3wAXJNMHq8GN4IHN-color.fit_limit.quality_80.size_300x130.v1749064288.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/06awWdi3wAXJNMHq8GN4IHN-color.fit_limit.quality_80.size_300x130.v1749064288.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/06awWdi3wAXJNMHq8GN4IHN-color.fit_limit.quality_80.size_600x260.v1749064288.png.webp 2x"
                                type="image/webp" alt="1-800 Contacts 1-800 Contacts Coupons, Promotions &amp; Deals"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#001c9b" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div>
                                    <h3 class="text-xs font-bold uppercase tracking-wide md:mt-2">1-800 Contacts</h3>
                                    <p
                                        class="my-2 line-clamp-2 font-proxima text-base capitalize leading-5 md:mb-auto md:line-clamp-3">
                                        1-800 Contacts Coupons, Promotions &amp; Deals</p>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="TWSHN54PDJEX3LDC3DEAVRNKFM" data-position="5" x-data="outclickHandler({ 'siteLink': '?u=TWSHN54PDJEX3LDC3DEAVRNKFM&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'ray-ban.com', 'offerUuid': 'TWSHN54PDJEX3LDC3DEAVRNKFM' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/06q2m6u7S33UiLVyBrWVxiP.fit_limit.quality_80.size_300x130.v1749062364.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/06q2m6u7S33UiLVyBrWVxiP.fit_limit.quality_80.size_300x130.v1749062364.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/06q2m6u7S33UiLVyBrWVxiP.fit_limit.quality_80.size_600x260.v1749062364.png.webp 2x"
                                type="image/webp" alt="Ray-Ban 15% Off Sitewide"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#ffffff" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div
                    ...
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="26J7WAQ4PBGTFERXQBCULOLRE4" x-data="outclickHandler({ 'siteLink': '?u=26J7WAQ4PBGTFERXQBCULOLRE4&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'zennioptical.com', 'offerUuid': '26J7WAQ4PBGTFERXQBCULOLRE4' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/03ApmIZK1X36IDdfB6yygvI-color.fit_limit.quality_80.size_300x130.v1749055785.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/03ApmIZK1X36IDdfB6yygvI-color.fit_limit.quality_80.size_300x130.v1749055785.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/03ApmIZK1X36IDdfB6yygvI-color.fit_limit.quality_80.size_600x260.v1749055785.png.webp 2x"
                                type="image/webp" alt="Zenni Optical 10% Off Your Order"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#0098ad" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div>
                    ...
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="ZARK6RL2KFHORKH2NSZH2YH7PU" data-position="7" x-data="outclickHandler({ 'siteLink': '?u=ZARK6RL2KFHORKH2NSZH2YH7PU&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'nutrafol.com', 'offerUuid': 'ZARK6RL2KFHORKH2NSZH2YH7PU' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/03hZZattNz0F7lqEmn21ZNH.fit_limit.quality_80.size_300x130.v1749054338.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/03hZZattNz0F7lqEmn21ZNH.fit_limit.quality_80.size_300x130.v1749054338.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/03hZZattNz0F7lqEmn21ZNH.fit_limit.quality_80.size_600x260.v1749054338.png.webp 2x"
                                type="image/webp" alt="Nutrafol $50 Off Your Purchase"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#ffffff" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div
                    ...
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="AJTQDHJ7TZFTRLDE36GX4GNKCA" data-position="8" x-data="outclickHandler({ 'siteLink': '?u=AJTQDHJ7TZFTRLDE36GX4GNKCA&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'sunglasshut.com', 'offerUuid': 'AJTQDHJ7TZFTRLDE36GX4GNKCA' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/06lUVK0L0aIAb8swITO4Wip-color.fit_limit.quality_80.size_300x130.v1749055054.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/06lUVK0L0aIAb8swITO4Wip-color.fit_limit.quality_80.size_300x130.v1749055054.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/06lUVK0L0aIAb8swITO4Wip-color.fit_limit.quality_80.size_600x260.v1749055054.png.webp 2x"
                                type="image/webp" alt="Sunglass Hut Up to $75 Off Sitewide"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#000000" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div>
                    ...
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="JYMDW5BWURETNI5CGMBYEB7B7Y" data-position="9" x-data="outclickHandler({ 'siteLink': '?u=JYMDW5BWURETNI5CGMBYEB7B7Y&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'eyebuydirect.com', 'offerUuid': 'JYMDW5BWURETNI5CGMBYEB7B7Y' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/02oJOICoQ0AnLAgz2QobaIF-color.fit_limit.quality_80.size_300x130.v1749062866.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/02oJOICoQ0AnLAgz2QobaIF-color.fit_limit.quality_80.size_300x130.v1749062866.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/02oJOICoQ0AnLAgz2QobaIF-color.fit_limit.quality_80.size_600x260.v1749062866.png.webp 2x"
                                type="image/webp" alt="EyeBuyDirect 35% Off $80 at EyeBuyDirect"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#cd9249" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div>
                                    <h3 class="text-xs font-bold uppercase tracking-wide md:mt-2">EyeBuyDirect</h3>
                                    <p
                                        class="my-2 line-clamp-2 font-proxima text-base capitalize leading-5 md:mb-auto md:line-clamp-3">
                                        35% Off $80 at EyeBuyDirect</p>
                                </div>
                                <p class="mt-2 self-start rounded-full bg-gray-100 px-4 py-1.5 text-xs font-bold lg:mb-1">
                                    Coupon code</p>
                            </div>
                    ...
                    <li class="relative flex h-32 flex-col md:h-auto">
                        <a href=""
                            class="relative mb-5 block flex h-full cursor-pointer overflow-hidden bg-white md:h-auto md:min-h-[278px] md:flex-col md:rounded-xl md:border lg:h-32 lg:flex-col"
                            data-content-uuid="ZIKX5EZOHVGP5CBCAX3I34B23A" data-position="10" x-data="outclickHandler({ 'siteLink': '?u=ZIKX5EZOHVGP5CBCAX3I34B23A&amp;outclicked=true', 'offerType': 'COUPON', 'requestSlug': 'swansonvitamins.com', 'offerUuid': 'ZIKX5EZOHVGP5CBCAX3I34B23A' })"
                            @click="juggleTabs"><img
                                src="https://www.CouponOnTop.com/imagery/merchants/04fsbg0CPTdAdjOVJe5kLzG-color.fit_limit.quality_80.size_300x130.v1749061750.png.webp"
                                srcset="https://www.CouponOnTop.com/imagery/merchants/04fsbg0CPTdAdjOVJe5kLzG-color.fit_limit.quality_80.size_300x130.v1749061750.png.webp 1x, https://www.CouponOnTop.com/imagery/merchants/04fsbg0CPTdAdjOVJe5kLzG-color.fit_limit.quality_80.size_600x260.v1749061750.png.webp 2x"
                                type="image/webp" alt="Swanson Up to 40% Off Sitewide + Free Shipping $29+"
                                class="relative flex flex aspect-video max-h-full max-w-36 shrink-0 flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-dynamic object-contain px-4 capitalize md:max-w-full md:rounded-none md:border-0 md:px-8"
                                style="--dynamic:#fcfeff" width="300" height="130">
                            <div class="relative flex h-full flex-col justify-between px-2 py-0 md:py-2">
                                <div>
                                    <h3 class="text-xs font-bold uppercase tracking-wide md:mt-2">Swanson</h3>
                                    <p
                                        class="my-2 line-clamp-2 font-proxima text-base capitalize leading-5 md:mb-auto md:line-clamp-3">
                                        Up to 40% Off Sitewide + Free Shipping $29+</p>
                                </div>
                                <p class="mt-2 self-start rounded-full bg-gray-100 px-4 py-1.5 text-xs font-bold lg:mb-1">
                                    Coupon code</p>
                            </div>
            ...
            <details class="group mb-8 border-b border-gray-200 pb-8 md:mt-20">
                <summary class="flex cursor-pointer justify-center text-2xl">
                    <span
                        class="w-4/5 text-base font-extrabold uppercase leading-tight tracking-wider md:w-2/3 md:leading-normal">Popular
                        Categories</span>
            ...
            <section class="mb-16 md:mb-20">
                <h2 class="mb-4 text-xl font-bold capitalize leading-tight md:leading-normal">3 Ways to Save With
                    CouponOnTop</h2>
                <ul class="flex gap-x-6 overflow-x-auto scrollbar-hide">
                    <li class="flex min-w-60 flex-col gap-y-6 lg:flex-row">
                        <img class="mr-5 h-20 w-20 shrink-0" src="/svg/images/explainer-cashback.svg" alt=""
                            role="presentation" width="80" height="80">
                        <div class="flex h-full flex-col uppercase tracking-widest lg:block">
                            <div class="text-sm font-bold">Cha-ching</div>
                            <div class="mb-4 text-sm normal-case tracking-normal">Cash back users earn up to 10% cash back
                                per order</div>
                            <a class="mr-auto text-xs font-semibold uppercase tracking-widest underline decoration-gray-400 underline-offset-2"
                                href="/cashback">Browse Cash Back</a>
                        </div>
                    </li>
                    <li class="flex min-w-60 flex-col gap-y-6 lg:flex-row" x-data="{}">
                        <img class="mr-5 h-20 w-20 shrink-0" src="/svg/images/explainer-app.svg" alt=""
                            role="presentation" width="80" height="80">
                        <div class="flex h-full flex-col uppercase tracking-widest lg:block">
                            <div class="text-sm font-bold">Save on the go</div>
                            <div class="mb-4 text-sm normal-case tracking-normal">Get app-only offers and the best of
                                CouponOnTop</div>
                            <div class="flex">
                                <a class="mb-2 border-r border-r-black pr-4 text-xs font-semibold uppercase tracking-widest underline decoration-gray-400 underline-offset-2"
                                    href="https://CouponOnTop.onelink.me/LeIP/eyooiv46"
                                    x-show="$store.browser.isIOS || (!$store.browser.isIOS &amp;&amp; !$store.browser.isAndroid)">iOS</a>
                                <a class="mb-2 ml-4 mr-auto text-xs font-semibold uppercase tracking-widest underline decoration-gray-400 underline-offset-2"
                                    href="https://CouponOnTop.onelink.me/LeIP/eyooiv46"
                                    x-show="$store.browser.isAndroid || (!$store.browser.isIOS &amp;&amp; !$store.browser.isAndroid)">Android</a>
                            </div>
                        </div>
                    </li>
                    <li class="flex min-w-60 flex-col gap-y-6 lg:flex-row">
                        <img class="mr-5 h-20 w-20 shrink-0" src="/svg/images/explainer-extension.svg" alt=""
                            role="presentation" width="80" height="80">
                        <div class="flex h-full flex-col uppercase tracking-widest lg:block">
                            <div class="text-sm font-bold">Save like magic</div>
                            <div class="mb-4 text-sm normal-case tracking-normal">Automatically apply codes + cash back
                                when you shop online</div>
                            <a class="mr-auto text-xs font-semibold uppercase tracking-widest underline decoration-gray-400 underline-offset-2"
                                href="https://www.CouponOnTop.com/extension">CouponOnTop Extension</a>
                        </div>
                    </li>
                </ul>
            </section>
            ...
            <section class=" mb-16 md:mb-20" id="">
                ...
                <details class="my-9 pb-9 border-b group mt-9 border-gray-200">
                    ...
                    <div class="prose mt-9 w-4/5 text-sm md:w-2/3">
                        <p>CouponOnTop offers several ways for shoppers to save while shopping. We feature up-to-date coupon
                            ...
                            Plus, our <a href="/cashback">cash back</a> offers pay you to shop! Activate a cash back
                ...
                <details class="my-9 pb-9 border-b group mt-9 border-gray-200">
                    ...
                    <div class="prose mt-9 w-4/5 text-sm md:w-2/3">
                        <p>Yes. CouponOnTop has <a href="/cashback">cash back</a> offers for nearly 3,800 stores. You can
                            access these cash back offers on our site, <a href="/mobile">via our app</a> or through our <a
                                href="/dealfinder">free browser extension</a>. Simply sign up for a CouponOnTop account,
                ...
                <details class="my-9 pb-9 border-b group mt-9 border-gray-200">
                    ...
                    <div class="prose mt-9 w-4/5 text-sm md:w-2/3">
                        <p>Yes. <a href="/extension">Install our free CouponOnTop browser extension</a>, on your preferred
                            ...
                            you never miss out on the best promo code for your purchase. <a
                                href="/extension">CouponOnTop's Browser Extension</a> sources and automatically applies
                ...
                <details class="my-9 pb-9 border-b group mt-9 border-gray-200">
                    ...
                    <div class="prose mt-9 w-4/5 text-sm md:w-2/3">
                        <p>Yes. The <a href="/mobile">CouponOnTop app</a> helps you find and use promo codes when you're
                            ...
                            you never miss out on a chance to save. You can also find and activate <a
                                href="/cashback">cash back</a> offers via the app and redeem your cash back balance.</p>
                    </div>
                </details>
            </section>
