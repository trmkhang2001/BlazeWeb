        ...
        <div
            ...
            <div class="relative z-40 lg:bg-transparent" @mouseenter="openMenu = 'categories'"
                ...
                <div x-show="openMenu === 'categories'"
                    ...
                    <a href="/shop/categories/tech" class="block px-4 py-2 hover:bg-gray-100">Tech</a>
                    <a href="/shop/categories/fashion" class="block px-4 py-2 hover:bg-gray-100">Fashion</a>
                    <a href="/shop/categories/home" class="block px-4 py-2 hover:bg-gray-100">Home</a>
                </div>
            </div>
            ...
            <div class="relative z-40 lg:bg-transparent" @mouseenter="openMenu = 'offers'"
                ...
                <div x-show="openMenu === 'offers'"
                    class="absolute left-0 mt-2 w-48 rounded bg-white p-2 shadow-lg text-black z-50" x-transition>
                    <a href="/shop/offers/summer" class="block px-4 py-2 hover:bg-gray-100">Summer Sale</a>
                    <a href="/shop/offers/clearance" class="block px-4 py-2 hover:bg-gray-100">Clearance</a>
                </div>
            </div>
            ...
            <div class="relative z-40 lg:bg-transparent" @mouseenter="openMenu = 'stores'"
                ...
                <div x-show="openMenu === 'stores'"
                    class="absolute left-0 mt-2 w-48 rounded bg-white p-2 shadow-lg text-black z-50" x-transition>
                    <a href="/shop/stores/nike" class="block px-4 py-2 hover:bg-gray-100">Nike</a>
                    <a href="/shop/stores/adidas" class="block px-4 py-2 hover:bg-gray-100">Adidas</a>
                </div>
            </div>
