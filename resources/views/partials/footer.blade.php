        ...
        <div class="isolate mt-8 pb-10 text-xs">
            <div class="mb-8 flex flex-col justify-between lg:mb-8 lg:flex-row lg:items-center">
                <div class="mb-8 flex lg:mb-0">
                    ...
                    <a class="mr-6 block h-10 w-10 items-center rounded-full fill-white hover:bg-white/10"
                        href="https://x.com/Couponontop" aria-label="CouponOnTop on X" target="_blank">
                        <svg class="mx-auto mt-2 h-6 w-6" fill="none" viewBox="0 0 25 24">
                            <path fill="currentColor"
                    ...
                    <a class="mr-6 block h-10 w-10 items-center rounded-full fill-white hover:bg-white/10"
                        href="https://www.tiktok.com/@couponontop" aria-label="CouponOnTop on TikTok" target="_blank">
